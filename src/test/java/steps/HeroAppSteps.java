...
public class HeroAppSteps {
    ...
    public void userClicksOnLink(String linkText) {
        heroAppPage.clickOnCategoryLink(linkText); // "Add/Remove Elements" --> coming from feature file
    }
    ...
    public void userShouldSeeButton(String buttonText) {
        /* if(buttonText.equals("Add Element")){
        ...
        //heroAppPage.validateButton(buttonText);
    ...
    // NOTE: WHEN THE STEPS IN THE FEATURE FILE IS OVERLAPPING OR SIMILAR TO ANOTHER BUT THE ELEMENT THEY ARE INTERACTING WITH IS DIFF:
    // 1. YOU CAN EDIT THE STEPS TO MAKE THOSE THAT ARE SIMILAR COMPLETELY DIFFERENT (edit the white texts in feature file)
    // 2. USE SWITCH CASES
    ...
    public void userShouldSeeAMessageStartsWith(String arg0) {
    }
}
